  ...
  module FFI
    ...
    class Api < ::FFI::Struct
      layout \
        ...
        :SessionOptionsAppendExecutionProvider_TensorRT_V2, callback(%i[pointer pointer], :pointer),
        :CreateTensorRTProviderOptions, callback(%i[pointer], :pointer),
        :UpdateTensorRTProviderOptions, callback(%i[pointer pointer pointer size_t], :pointer),
        :GetTensorRTProviderOptionsAsString, callback(%i[pointer pointer pointer], :pointer),
        :ReleaseTensorRTProviderOptions, callback(%i[pointer], :pointer),
